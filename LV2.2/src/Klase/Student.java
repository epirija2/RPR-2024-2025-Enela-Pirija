...
public class Student {
    ...
    public Student(String ime, String prezime, Date datumRodjenja, String brojIndeksa,
                   Odsjek odsjek, Integer godinaStudija ) throws StudentBuducnostException,
            PremladStudentException {
        setIme(ime);
        setPrezime(prezime);
    ...
    public void setGodinaStudija(Integer godinaStudija) {
        ...
        else if(this.odsjek == Odsjek.RS && (godinaStudija > 0 && godinaStudija < 3))
            this.godinaStudija = godinaStudija;
    }
    ...
    public void setDatumRodjenja(Date datumRodjenja) throws StudentBuducnostException,
            PremladStudentException {
        Date today = new Date();
