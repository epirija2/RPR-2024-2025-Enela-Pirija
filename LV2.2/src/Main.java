    ...
    public static void main(String[] args) {
        ...
        while (!uspjesanUnos) {
            try {
                ...
                String ocjeneStr = scanner.nextLine();
                String[] ocjeneStr1 = ocjeneStr.split(",");
                List<Integer> ocjeneList = new ArrayList<Integer>();
                for (String ocjena : ocjeneStr1)
                    ocjeneList.add(Integer.valueOf(ocjena));
